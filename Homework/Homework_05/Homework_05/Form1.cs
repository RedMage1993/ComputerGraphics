...
namespace Homework_05
{
    public partial class Form1 : Form
    {
        ...
        private Image mtnBg = Image.FromFile("mountain-landscape-cartoon-sm.bmp"); // mountain background
        private SoundPlayer splayer = new SoundPlayer("turbine.wav");
        ...
        private PointF[] getBasePoints(PointF pin)
        {
            ...
            points[1].X = pin.X - 10;
            points[1].Y = pin.Y + 200;

            points[2].X = pin.X + 30;
            points[2].Y = pin.Y + 200;
        ...
        private void bgwDrawing_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            while (true)
            {
                ...
                graphics.DrawImage(mtnBg, -(dbmp.Width >> 1) + 1, -(dbmp.Height >> 1));
